...
enum opt_code
{
  ...
  OPT_fcyclomatic_complexity = 964,          /* -fcyclomatic-complexity */
  ...
  OPT_mfix_cmse_cve_2021_35465 = 1696,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_m3_ldrd = 1697,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1698,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1699,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1700,                  /* -mfp16-format= */
  OPT_mfpu_ = 1701,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1702,             /* -mgeneral-regs-only */
  ...
  OPT_mneon_for_64bits = 1707,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1708,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1709,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1710,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1711,               /* -mprint-tune-info */
  OPT_mpure_code = 1712,                     /* -mpure-code */
  OPT_mrestrict_it = 1713,                   /* -mrestrict-it */
  OPT_msched_prolog = 1714,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1715,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1716,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1717, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1718,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1719,                         /* -mthumb */
  OPT_mthumb_interwork = 1720,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1721,                  /* -mtls-dialect= */
  OPT_mtp_ = 1722,                           /* -mtp= */
  OPT_mtpcs_frame = 1723,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1724,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1725,                         /* -mtune= */
  OPT_munaligned_access = 1726,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1727,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1728,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1729,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1730,              /* -mword-relocations */
  OPT_n = 1731,                              /* -n */
